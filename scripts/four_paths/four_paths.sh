...
./build/antpov -f data/seville/ground_and_veg_inner_circular.gltf \
               -c data/seville/Ant06R05-warped.csv.world.csv,data/seville/Ant03R05-warped.csv.world.csv,data/seville/Ant11R06-warped.csv.world.csv,data/seville/Ant12R02-warped.csv.world.csv -x
