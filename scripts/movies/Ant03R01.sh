...
./build/antpov -d 1450x1800 -f data/seville/ground_and_veg_inner_dual.gltf  -c data/seville/Ant03R01-warped.csv.world.csv -j data/seville/Ant03R01-warped.csv.world.topdown_higher.json -m -x -F
